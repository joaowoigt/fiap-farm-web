  ...
  return (
    <>
      <div className="ui-relative">
        <div
          className="ui-outline ui-outline-1 ui-outline-primary  ui-bg-white ui-rounded-md ui-px-3 ui-w-[250px] mobile:ui-w-[270px] ui-py-3 ui-text-black ui-text-start ui-flex ui-flex-row ui-justify-between hover:ui-cursor-pointer"
          onClick={toggle}
        >
        ...
        >
          {menuDropDownItems.map((item) => (
            <a
              key={item.title}
              className="hover:ui-bg-secondary-light  hover:ui-font-semibold hover:ui-cursor-pointer ui-text-black ui-w-[250px] ui-text-center ui-py-3 mobile:ui-w-[270px]"
              onClick={() => {
                onItemSelected(item);
